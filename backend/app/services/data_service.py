...
def clear_trade_history(db: Session, user_id: int) -> None:
    ...
    try:
        ...
        # - AccountTransaction (deposits/withdrawals)
        # - User settings (initial_account_balance, starting_balance_date, etc.)
